...
namespace ProiectCS
{
    public partial class TravelController : Form
    {
        ...
        public TravelController(FlightServices flightServices, TicketServices ticketServices)
        {
            this.flightServices = flightServices;
            this.ticketServices = ticketServices;
            InitializeComponent();
            IEnumerable<Flight> flights = flightServices.findALL();
        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            ...
            string destination = textBosDest.Text;
            DateTime departure = dateTimePick.Value;
            IEnumerable<Flight> flights = flightServices.filterFlightsByDestinationAndDeparture(destination, departure);
            foreach (var flight in flights)
        ...
        private void buttonBuyTicket_Click(object sender, EventArgs e)
        {
            ...
            TicketController ticketController = new TicketController(ticketServices, flightForTicket);
