...
namespace ProiectCS
{
    public class TicketController : Form
    {
        ...
        public TicketController(TicketServices ticketServices, Flight flightForTicket)
        {
        ...
        private void buttonBuy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ticketServices.addTicket(ticket.CustomerName, ticket.TouristName, ticket.CustomerAddress,
                    ticket.Seats, flightForTicket);
